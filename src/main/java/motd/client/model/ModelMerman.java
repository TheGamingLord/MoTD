 ...
 */
public class ModelMerman extends ModelBase {
	...
	public ModelMerman() {
		...
		this.shape24 = new ModelRenderer(this, 52, 5);
		this.shape24.setRotationPoint(0.0F, -13.0F, -1.0F);
		this.shape24.addBox(0.0F, 0.0F, 0.0F, 0, 3, 6, 0.0F);
		...
		this.field_78188_e = new ModelRenderer(this, 40, 54);
		...
		this.field_78188_e_2 = new ModelRenderer(this, 0, 51);
		...
		this.shape24_1 = new ModelRenderer(this, 0, -3);
		this.shape24_1.setRotationPoint(0.0F, 0.0F, 3.4F);
		this.shape24_1.addBox(0.0F, 0.0F, 0.0F, 0, 6, 3, 0.0F);
	}
