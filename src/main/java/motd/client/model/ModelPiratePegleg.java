 ...
 */
public class ModelPiratePegleg extends ModelBase {
    ...
    public ModelPiratePegleg() {
        this.textureWidth = 70;
        this.textureHeight = 70;
        this.field_191224_h = new ModelRenderer(this, 28, 16);
        ...
        this.field_191221_e = new ModelRenderer(this, 48, 11);
        ...
        this.field_191218_b1 = new ModelRenderer(this, 38, 27);
        ...
        this.shape15_1.setRotationPoint(-3.1F, 16.8F, -1.1F);
        this.shape15_1.addBox(0.0F, 0.0F, 0.0F, 2, 7, 2, 0.0F);
        this.shape15 = new ModelRenderer(this, 21, 32);
