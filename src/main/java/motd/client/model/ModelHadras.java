 ...
 */
public class ModelHadras extends ModelBase {
    ...
    public ModelRenderer field_191217_a_2;
    ...
    public ModelHadras() {
        ...
        this.field_191217_a_1 = new ModelRenderer(this, 0, 59);
        this.field_191217_a_1.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.field_191217_a_1.addBox(-3.0F, -12.2F, -3.0F, 6, 5, 6, 0.0F);
        ...
        this.field_191217_a_2 = new ModelRenderer(this, 24, 61);
        this.field_191217_a_2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.field_191217_a_2.addBox(-2.0F, -13.7F, -2.0F, 4, 5, 4, 0.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        this.field_191217_a_1.render(f5);
        this.field_191220_d.render(f5);
        this.field_191218_b0.render(f5);
        this.field_191217_a_2.render(f5);
